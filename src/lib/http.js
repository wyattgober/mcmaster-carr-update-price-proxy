...
/**
 * Same TLS/cert/timeout as request(), but response body is a Buffer (no UTF-8 or JSON parse).
 * Use for image/CAD/binary downloads from McMaster.
 */
...
module.exports = { request, requestBinary };
